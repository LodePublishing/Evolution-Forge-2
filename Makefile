...
SIMULATOR_TEST_DEPS = $(SIMULATOR_TEST_DIR)/$(SIMULATOR_TEST).a $(SIMULATOR_FIXTURE_DIR)/$(SIMULATOR_FIXTURE).a $(SIMULATOR_DIR)/$(SIMULATOR).a $(MISC_DIR)/$(MISC).a $(GEOMETRY_DIR)/$(GEOMETRY).a $(CORE_DIR)/$(CORE).a $(GOAL_DIR)/$(GOAL).a $(LANG_DIR)/$(LANG).a
...
UI_TEST_DEPS = $(UI_TEST_DIR)/$(UI_TEST).a $(UI_FIXTURE_DIR)/$(UI_FIXTURE).a $(UI_DIR)/$(UI).a $(GUI_DIR)/$(GUI).a $(SDLWRAP_DIR)/$(SDLWRAP).a $(GUICORE_DIR)/$(GUICORE).a $(MISC_DIR)/$(MISC).a $(GEOMETRY_DIR)/$(GEOMETRY).a $(LANG_DIR)/$(LANG).a

MAIN_TEST_DEPS = $(MAIN_TEST_DIR)/$(MAIN_TEST).a $(MAIN_FIXTURE_DIR)/$(MAIN_FIXTURE).a $(MAIN_DIR)/$(MAIN).a $(GUI_FIXTURE_DIR)/$(GUI_FIXTURE).a $(GUI_DIR)/$(GUI).a $(SDLWRAP_DIR)/$(SDLWRAP).a $(GUICORE_FIXTURE_DIR)/$(GUICORE_FIXTURE).a $(GUICORE_DIR)/$(GUICORE).a $(LANG_FIXTURE_DIR)/$(LANG_FIXTURE).a $(LANG_DIR)/$(LANG).a $(MISC_DIR)/$(MISC).a $(GEOMETRY_DIR)/$(GEOMETRY).a
...
SIMULATOR_TEST_TARGETS = $(SIMULATOR_TEST) $(SIMULATOR) $(SIMULATOR_FIXTURE) $(MISC) $(GEOMETRY) $(CORE) $(GOAL) $(BUILD) $(AI) $(LANG)
...
GUI_TEST_TARGETS = $(GUI_TEST) $(GUI_FIXTURE) $(GUI) $(SDLWRAP) $(GUICORE_FIXTURE) $(GUICORE) $(LANG) $(MISC) $(GEOMETRY) $(LANG)

UI_TEST_TARGETS = $(UI_TEST) $(UI_FIXTURE) $(UI) $(GUI) $(SDLWRAP) $(GUICORE) $(MISC) $(GEOMETRY) $(LANG)
