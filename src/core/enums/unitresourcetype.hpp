...
// global facility continues to exist until construction is complete (e.g. researches)
	...
	USES_SPEED_UPGRADE, // if this unit is globally built then the speed upgrade is available
	
	IS_SPEED_UPGRADE, // count = time (e.g. stim), 0 = permanent, TODO hp cost? cooldown?
	SPEED_HP_COST,
	SPEED_COOLDOWN,
...
#endif // _CORE_UNITRESOURCETYPEENUMS_HPP