...
#include "enums/starcraftraces.hpp"
#include "enums/starcraftunits.hpp"
...
{ 
	rules = boost::shared_ptr<const Rules>(new Rules(Misc::uuid("{17d83100-3194-11e0-91fa-0800200c9a66}"), "StarCraft", init_racelist_helper(), init_unittypelist_helper()));
	initRules();
}
...
const std::list<boost::shared_ptr<const Race> > StarCraft::init_racelist_helper() const {
...
const std::map<const unsigned int, const boost::uuids::uuid> StarCraft::init_raceidmap_helper() const {
	std::map<const unsigned int, const boost::uuids::uuid> raceIdMap;

	raceIdMap.insert(std::pair<const unsigned int, const boost::uuids::uuid>(NEUTRAL_RACE, Misc::uuid("{709a4a10-3196-11e0-91fa-0800200c9a66}")));
	raceIdMap.insert(std::pair<const unsigned int, const boost::uuids::uuid>(TERRA_RACE, Misc::uuid("{7354fd40-3196-11e0-91fa-0800200c9a66}")));
	raceIdMap.insert(std::pair<const unsigned int, const boost::uuids::uuid>(PROTOSS_RACE, Misc::uuid("{7354fd40-3196-11e0-91fa-0800200c9a66}")));
	raceIdMap.insert(std::pair<const unsigned int, const boost::uuids::uuid>(ZERG_RACE, Misc::uuid("{78dd0140-3196-11e0-91fa-0800200c9a66}")));

	return raceIdMap;
}

const std::map<const unsigned int, const boost::uuids::uuid> StarCraft::init_unitidmap_helper() const {
...
const std::list<boost::shared_ptr<const UnitType> > StarCraft::init_unittypelist_helper() {
