...
DataBaseEntry::DataBaseEntry(Object* entry_parent, const Rect& entry_rect, const Size distance_bottom_right, const ePositionMode position_mode, const std::string& text, const eDataEntry data_entry_type, const unsigned int entry_count) :
	Object(entry_parent, Rect(entry_rect.getTopLeft(), Size(entry_parent->getWidth(), 12)), distance_bottom_right, position_mode, AUTO_HEIGHT_CONST_WIDTH),
	myGoal(0),
	myBO(0),
	myRace(0),
	entry(new Button(this, Rect(Point(data_entry_type==DATA_RACE_ENTRY?15:data_entry_type==DATA_GOAL_ENTRY?30:45, 0), 
	...
	checkButton(new Button(this, Rect(Point(getWidth() - 30, 0), Size(12, 12)), Size(), CHECK_BUTTON, RADIO_OFF, CHECK_BUTTON_MODE, NULL_STRING, DATA_ENTRY_CHECK_BUTTON_TOOLTIP_STRING)),
