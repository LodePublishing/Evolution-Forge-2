...
{
	public:
		DataBaseEntry(Object* entry_parent, const Rect& entry_rect, const Size distance_bottom_right, const ePositionMode position_mode, const std::string& text, const eDataEntry data_entry_type, const unsigned int entry_count = 0);
		~DataBaseEntry();
