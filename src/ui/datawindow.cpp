...
DataBaseWindow::DataBaseWindow(Object* database_parent) :
	Window(database_parent, DATABASE_WINDOW_TITLE_STRING, theme.lookUpGlobalRect(DATABASE_WINDOW), theme.lookUpGlobalMaxHeight(DATABASE_WINDOW), NOT_SCROLLED),
	dataList(),
	dataListWindow(new Window(this, NULL_STRING, theme.lookUpGlobalRect(DATALIST_WINDOW), theme.lookUpGlobalMaxHeight(DATALIST_WINDOW), SCROLLED)),
	currentRace(0),
...
//	game->initSoup();
//	toInitLog("* " + Object::theme.lookUpString(START_MEASURING_FITNESS_STRING));
//	game->newGeneration();
}
