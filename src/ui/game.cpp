...
Game::Game(Object* game_parent, const BASIC_MAP* game_map, const unsigned int game_number, const unsigned int game_max) :
	Window(game_parent, GAME_WINDOW_TITLE_STRING, theme.lookUpGameRect(GAME_WINDOW, game_number, game_max), theme.lookUpGameMaxHeight(GAME_WINDOW, game_number, game_max), NOT_SCROLLED, NO_AUTO_SIZE_ADJUST, Rect(0,0,1280,1024), TRANSPARENT_WINDOW),
...
//	splitGameButton(new Button(this, Rect(0, 0, 0, 0), Size(30, 0), MY_BUTTON, false, PRESS_BUTTON_MODE, COMPARE_GAME_STRING, DO_NOT_ADJUST, SMALL_BOLD_FONT, AUTO_HEIGHT_CONST_WIDTH)),
{
...
{
	setOriginalRect(Object::theme.lookUpGameRect(GAME_WINDOW, gameNumber, gameMax));
	setMaxHeight(Object::theme.lookUpGameMaxHeight(GAME_WINDOW, gameNumber, gameMax));
...
{
	toInitLog("* " + Object::theme.lookUpString(START_ASSIGNING_MAP_STRING));
#ifdef _SCC_DEBUG
	if(game_map == NULL) {
...
#endif
	toInitLog("* " + Object::theme.lookUpString(START_SETTING_RACE_STRING));
...
{
	toInitLog("* " + Object::theme.lookUpString(START_ASSIGNING_GOAL_STRING));
...
void Game::initSoup() 
{
	toInitLog("* " + Object::theme.lookUpString(START_CREATING_BUILD_ORDERS_STRING));
	unchangedGenerations = 0;
...
//	else splitGameButton->Show();
	...
	scoreWindow->setTitleParameter(Object::theme.lookUpFormattedString(GAME_WINDOW_TITLE_STRING, os.str()));
}

void Game::draw() const
{
	Object::theme.setColorTheme(Object::theme.getMainColorTheme()); // TODO
	Object::draw();
...
{
	toInitLog("* " + Object::theme.lookUpString(START_SETTING_START_POSITION_STRING));
...
{
	toInitLog("* " + Object::theme.lookUpString(START_ASSIGNING_START_CONDITION_STRING));
