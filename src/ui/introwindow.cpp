...
IntroWindow::IntroWindow(Object* intro_parent) :
	Window(intro_parent, INTRO_WINDOW_TITLE_STRING, theme.lookUpGlobalRect(INTRO_WINDOW), theme.lookUpGlobalMaxHeight(INTRO_WINDOW), SCROLLED, NO_AUTO_SIZE_ADJUST, Rect(0, 0, 1280, 1024)),			
//	text(NULL),
	text(new LongText(getScrollBar(), Rect(Point(20, 30), Size(getSize()-Size(80, 60))), Size(0, 0), intro_string, BRIGHT_TEXT_COLOR, FORCE_TEXT_COLOR, LARGE_FONT, TEXT_BUTTON, VISITED_TEXT_BUTTON, getScrollBar())),
//	doneButton(NULL),
	doneButton(new Button(this, Rect(0, 0, Object::theme.lookUpButtonWidth(STANDARD_BUTTON_WIDTH), 0), Size(20, 10), STANDARD_BUTTON, NULL_BITMAP, PRESS_BUTTON_MODE, SAVE_BOX_OK_STRING, BOTTOM_RIGHT, HUGE_BOLD_FONT, AUTO_HEIGHT_CONST_WIDTH)),
...
{
	setOriginalRect(Object::theme.lookUpGlobalRect(INTRO_WINDOW));
	setMaxHeight(Object::theme.lookUpGlobalMaxHeight(INTRO_WINDOW));

	doneButton->setOriginalSize(Size(Object::theme.lookUpButtonWidth(STANDARD_BUTTON_WIDTH), 0));
