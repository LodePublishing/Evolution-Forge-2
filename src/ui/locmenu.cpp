...
LocationMenu::LocationMenu(Object* location_parent, ANABUILDORDER* location_anarace, Rect location_rect, const Size distance_bottom_right, const ePositionMode position_mode):
	Menu(location_parent, location_rect, distance_bottom_right, position_mode, true),
...
void LocationMenu::draw(DC* const dc) const
{
	if(!isShown()) {
		return;
	}
