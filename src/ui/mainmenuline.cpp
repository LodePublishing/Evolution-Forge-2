...
MainMenuLine::MainMenuLine(Object* main_parent) : 
	...
	removeCurrentTabButton(new Button(this, Rect( Point((theme.lookUpButtonWidth(SMALL_BUTTON_WIDTH)+2)*MAX_VISIBLE_GAME_TABS + 30, 2), Size()), Size(), MENU_BUTTON, CANCEL_BITMAP, PRESS_BUTTON_MODE, NULL_STRING, DO_NOT_ADJUST)),
	scrollLeftButton(new Button(this, Rect(0, 2, 8, 8), Size(0,0), ARROW_BUTTON, SMALL_ARROW_LEFT_BITMAP, PRESS_BUTTON_MODE, NULL_STRING)),
	scrollRightButton(new Button(this, Rect( Point((theme.lookUpButtonWidth(SMALL_BUTTON_WIDTH)+2)*MAX_VISIBLE_GAME_TABS + 15, 2), Size(8, 8)), Size(0,0), ARROW_BUTTON, SMALL_ARROW_RIGHT_BITMAP, PRESS_BUTTON_MODE, NULL_STRING)),
	gameTabCount(0),
	gameNumber(1),
	viewTabs(0),
	leftTabs(new Group(this, Rect(Point(10, -3), Size(100,0)), Size(0, 0), HORIZONTAL_GROUP, false, TOP_LEFT, NULL_STRING)),
	rightTabs(new Group(this, Rect(Point(0, -3), Size(100,0)), Size(0, 0), HORIZONTAL_GROUP, false, TOP_RIGHT, NULL_STRING)),
	oldTab((eTabs)0),
	tabHasChanged(true),
	markForRemove(false),
