...
ScoreWindow::ScoreWindow(Object* score_parent, const unsigned int game_number, const unsigned int game_max) :
	Window(score_parent, TIMER_WINDOW_TITLE_STRING, theme.lookUpGameRect(SCORE_WINDOW, game_number, game_max), theme.lookUpGameMaxHeight(SCORE_WINDOW, game_number, game_max), NOT_SCROLLED),
	currentPlayer(0),
	players(0),
	maxPlayer(0),
	unchangedGenerations(0),
//	mapMenuButton(new Button(this, Rect(Point(10, 20), Size(100, 50)), Size(5,5), MY_BUTTON, false, STATIC_BUTTON_MODE, database.getMap(0)->getName(), ARRANGE_TOP_LEFT, SMALL_BOLD_FONT, AUTO_HEIGHT_CONST_WIDTH)),
...
//		goalsFulfilledText[i] = new StaticText(this, getRelativeClientRect() + Point(100, i * 20), IMPORTANT_COLOR, SMALL_BOLD_FONT, NO_TEXT_MODE); TODO => tooltip
...
void ScoreWindow::draw() const
{
	...
	{
		dc->setPen(*Object::theme.lookUpPen(BODIAGRAM_FITNESS_PEN));
