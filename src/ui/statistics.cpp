...
StatisticsWindow::StatisticsWindow(Object* stat_parent, const unsigned int stat_window_number):
	Window(stat_parent, STATISTICS_WINDOW_TITLE_STRING, STATISTICS_WINDOW, stat_window_number, NOT_SCROLLED),
	ani(5),
	...
	wasResetted(false)
{
	...
	{
		statEntry[i] = new Button(this, Rect(l1+Point(0,i*14), l2), (eString)(MINERALS_STAT_STRING+i), (eButton)(MINERALS_STAT_BUTTON+i), NO_TEXT_MODE, STATIC_BUTTON_MODE, DO_NOT_ADJUST, SMALL_NORMAL_BOLD_FONT, NO_AUTO_SIZE);
...
//	statEntry[GENERATIONS_LEFT_STAT_ENTRY]->updateText(theme.lookUpFormattedString(GENERATIONS_LEFT_STAT_STRING, data[GENERATIONS_LEFT_STAT_ENTRY][199], anarace->getTotalGeneration()));
	...
	std::ostringstream os;
	os.str("");
	os << data[FPS_STAT_ENTRY][199] << " fps ";/* [" << Object::rectnumber << " updates]";*/
