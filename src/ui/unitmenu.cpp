	...
	lastRace(0)
{
	...
	{
		MenuEntry* entry = new MenuEntry(this, Rect(), "");
...
//								unit_type = GAS_SCV;
							...
							(*m)->updateText(os.str());
							os.str("");
							os << GAME::lookUpUnitString(lastRace, unit_type) << "#" << "  " << Object::theme.lookUpFormattedString(BOWINDOW_BUILD_TIME_STRING, GAME::race[lastRace].stats[unit_type].BT/(efConfiguration.getGameSpeed()*3+6)) << "#";
